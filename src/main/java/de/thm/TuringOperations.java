...
class TuringOperations {
    private TuringOperations(){};

    // Diese Methode dekrementiert eine Binärzahl - allerdings mit dem konventionellen Start des Kopfes an Position 0
